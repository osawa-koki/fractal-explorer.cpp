...
Config* commandline_parser() {
  ...
  burning_ship->color_hue = stoi(burning_ship_node.child("color_hue").child_value());
  ...
  barnsley_fern->size_x = stod(barnsley_fern_node.child("size_x").child_value());
  barnsley_fern->size_y = stod(barnsley_fern_node.child("size_y").child_value());
  ...
  pythagoras_tree->color_from_hue = stoi(pythagoras_tree_node.child("color_from_hue").child_value());
  pythagoras_tree->color_upto_hue = stoi(pythagoras_tree_node.child("color_upto_hue").child_value());
